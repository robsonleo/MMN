...
namespace antonov.GUI.UsersControls.Table
{
    class TableViewModel:ViewModelBase
    {
        ...
        public int WidthBorder => WidthColumn;
        ...
        public List<string> COLUMN{get { return new List<string>() {"dew", "wf"}; }} 

        //private ObservableCollection<List<string>> InitialRows()
        //{
        //    ObservableCollection<List<string>> rows = new ObservableCollection<List<string>>() { new List<string> { "строка 1", "wf" }, new List<string> { "строка 2", "wf 2" }, new List<string> { "строка 2", "wf 2" } };
        //    return rows;
        //}


            public List<string> rows=new List<string>() {"row1", "row2", "row3"}; 

        private GridViewColumnCollection _columnCollection;
        public GridViewColumnCollection ColumnCollection
        {
            get
            {
                _columnCollection=new GridViewColumnCollection();

                _columnCollection.Add(new GridViewColumn() {Header = "header 1", DisplayMemberBinding = new Binding("rows")});
                _columnCollection.Add(new GridViewColumn() { Header = "header 2" });
